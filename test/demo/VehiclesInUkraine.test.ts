...
test("Entity position", () => {
  ...
  expect(entities.at(0)!.position).not.toEqual(Cartesian3.fromDegrees(0, 0, 0));
  expect(entities.at(1)!.position).not.toEqual(Cartesian3.fromDegrees(0, 0, 0));
  expect(entities.at(2)!.position).not.toEqual(Cartesian3.fromDegrees(0, 0, 0));
  expect(entities.at(3)!.position).not.toEqual(Cartesian3.fromDegrees(0, 0, 0));
